...
const ENEMIES = {
  kendo:   { name:'Daichi',      spr:'daichi',  hp:40,  atk:6,  def:2,  mag:0,  spd:5,  xp:0,   gold:0, skills:['feint'], human:true, brk:40 },
  swordmaster:{ name:'Master Corwin', spr:'swordmaster', hp:120, atk:5, def:3, mag:0, spd:5, xp:0, gold:0, skills:['lunge','crush'], human:true, brk:60 },
  ...
  duel:    { name:'Garrick',     spr:'garrick', hp:260, atk:17, def:12, mag:0,  spd:4,  xp:40,  gold:0,  skills:['smash','crush','guardup'], human:true, brk:120 },
  bandit:  { name:'Road Bandit', spr:'bandit',  hp:34,  atk:12, def:4,  mag:0,  spd:8,  xp:12,  gold:18, skills:['feint','blind','pilfer'], human:true },
  banditboss:{ name:'Rafe the Red', spr:'banditboss', hp:120, atk:17, def:7, mag:0, spd:7, xp:50, gold:80, skills:['crush','howl'], human:true, elite:true, brk:80 },
  thug:    { name:'Gutter Thug', spr:'thug',    hp:40,  atk:13, def:5,  mag:0,  spd:6,  xp:14,  gold:12, skills:['smash','guardup'], human:true },
  sableE:  { name:'Sable',       spr:'sable',   hp:110, atk:12, def:4,  mag:0,  spd:14, xp:30,  gold:0,  skills:['feint','blind','pilfer'], human:true, brk:60 },
  poacher: { name:'Poacher',     spr:'poacher', hp:42,  atk:14, def:5,  mag:0,  spd:9,  xp:16,  gold:14, skills:['feint','blind'], human:true },
  ...
  bandit2: { name:'Border Raider',spr:'bandit', hp:70,  atk:24, def:10, mag:0,  spd:9,  xp:48,  gold:30, skills:['feint','blind'], human:true },
